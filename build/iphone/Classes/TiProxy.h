...
//Rare exceptions to indicate a bug in the _queens_memory code (Eg, function that a subclass should have implemented)
...
/**
 The base class for Queens_Memory proxies.
 */
