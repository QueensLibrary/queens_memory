...
/**
 The base class for all Queens_Memory modules
 */
...
/**
 Queens_Memory Platform calls this method on startup.
 */
-(void)startup;

/**
 Queens_Memory Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 Queens_Memory Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 Queens_Memory Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 Queens_Memory Platform calls this method on resume.
 @param sender The sender of the event.
 */
