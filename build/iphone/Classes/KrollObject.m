...
//@interface Queens_MemoryObject : NSObject
//@end

@interface Queens_MemoryObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Queens_MemoryObject class]])
		{
			for (NSString *key in [[(Queens_MemoryObject*)o modules] allKeys])
			{
