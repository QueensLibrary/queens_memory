...
// in simulator we redefine to format for Queens_Memory Developer console
...
{\
	NSString * exceptionName = [@"org.queens_memory." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.queens_memory";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIQueens_MemoryNativeItemNone = -1, 
	UIQueens_MemoryNativeItemSpinner = -2,
	UIQueens_MemoryNativeItemProgressBar = -3,
	
	UIQueens_MemoryNativeItemSlider = -4,
	UIQueens_MemoryNativeItemSwitch = -5,
	UIQueens_MemoryNativeItemMultiButton = -6,
	UIQueens_MemoryNativeItemSegmented = -7,
	
	UIQueens_MemoryNativeItemTextView = -8,
	UIQueens_MemoryNativeItemTextField = -9,
	UIQueens_MemoryNativeItemSearchBar = -10,
	
	UIQueens_MemoryNativeItemPicker = -11,
	UIQueens_MemoryNativeItemDatePicker = -12,
	
	UIQueens_MemoryNativeItemInfoLight = -13,
	UIQueens_MemoryNativeItemInfoDark = -14,
	
	UIQueens_MemoryNativeItemDisclosure = -15,
	
	UIQueens_MemoryNativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all Queens_Memory instances of
