...
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED(BIG, UIActivityIndicatorViewStyleWhiteLarge, @"UI.iPhone.ActivityIndicatorStyle.BIG", @"5.1.0", @"UI.ActivityIndicatorStyle.BIG");
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED(DARK, UIActivityIndicatorViewStyleGray, @"UI.iPhone.ActivityIndicatorStyle.DARK", @"5.1.0", @"UI.ActivityIndicatorStyle.DARK");
