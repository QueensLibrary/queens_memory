...
/**
 Base class for all Queens_Memory views.
 @see TiViewProxy
 */
#ifdef TI_USE_AUTOLAYOUT
...
/**
 Whether or not a view not normally picked up by the Queens_Memory view hierarchy (such as wrapped iOS UIViews) was touched.
