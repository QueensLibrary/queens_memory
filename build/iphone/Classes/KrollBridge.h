...
@interface Queens_MemoryObject : KrollCoverageObject {
#else
@interface Queens_MemoryObject : KrollObject {
#endif
@private
...
extern NSString * Queens_Memory$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Queens_MemoryObject *_queens_memory;
    KrollObject* console;
	BOOL shutdown;
