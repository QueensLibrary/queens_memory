...
function Controller() {
    ...
    var exports = {};
    var __defers = {};
    $.__views.connectWin = Ti.UI.createWindow({
    ...
    $.__views.connectWin.add($.__views.__alloyId122);
    $.__views.body = Ti.UI.createView({
        id: "body"
    });
    $.__views.__alloyId122.add($.__views.body);
    ...
    openFacebook ? $.addListener($.__views.facebookButton, "click", openFacebook) : __defers["$.__views.facebookButton!click!openFacebook"] = true;
    $.__views.twitterButton = Ti.UI.createButton({
        font: {
            fontFamily: "Montserrat-Regular"
        },
        width: "400px",
    ...
    openTwitter ? $.addListener($.__views.twitterButton, "click", openTwitter) : __defers["$.__views.twitterButton!click!openTwitter"] = true;
    $.__views.instagramButton = Ti.UI.createButton({
        font: {
            fontFamily: "Montserrat-Regular"
        },
        width: "400px",
    ...
    openInstagram ? $.addListener($.__views.instagramButton, "click", openInstagram) : __defers["$.__views.instagramButton!click!openInstagram"] = true;
    $.__views.tumblrButton = Ti.UI.createButton({
        font: {
            fontFamily: "Montserrat-Regular"
        },
        width: "400px",
    ...
    openTumblr ? $.addListener($.__views.tumblrButton, "click", openTumblr) : __defers["$.__views.tumblrButton!click!openTumblr"] = true;
    ...
    __defers["$.__views.facebookButton!click!openFacebook"] && $.addListener($.__views.facebookButton, "click", openFacebook);
    __defers["$.__views.twitterButton!click!openTwitter"] && $.addListener($.__views.twitterButton, "click", openTwitter);
    __defers["$.__views.instagramButton!click!openInstagram"] && $.addListener($.__views.instagramButton, "click", openInstagram);
    __defers["$.__views.tumblrButton!click!openTumblr"] && $.addListener($.__views.tumblrButton, "click", openTumblr);
    _.extend($, exports);
}
