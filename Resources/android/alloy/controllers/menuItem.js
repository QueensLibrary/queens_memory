...
function Controller() {
    ...
    onItemClick ? $.addListener($.__views.itemContainer, "click", onItemClick) : __defers["$.__views.itemContainer!click!onItemClick"] = true;
    onSwipe ? $.addListener($.__views.itemContainer, "swipe", onSwipe) : __defers["$.__views.itemContainer!swipe!onSwipe"] = true;
    ...
    $.setActive = function(state) {
        if (true === isSeparator) $.index.backgroundColor = "transparent"; else if (true === args.item.highlighted) $.index.backgroundColor = Alloy.Globals.Colors.orange; else if (true === state) {
    ...
    $.setIsSeparator = function(_isSeparator) {
        ...
        true === _isSeparator && ($.separator.visible = false);
    };
    enabled ? $.enable() : $.disable();
    __defers["$.__views.itemContainer!click!onItemClick"] && $.addListener($.__views.itemContainer, "click", onItemClick);
    __defers["$.__views.itemContainer!swipe!onSwipe"] && $.addListener($.__views.itemContainer, "swipe", onSwipe);
    _.extend($, exports);
}
